...
import com.zay.annotation.Permission;
import com.zay.web.result.JsonResult;
import com.zay.web.result.ResultCode;
...
public class ControllerInterceptor {
	...
	/**
	 * 定义拦截规则：拦截com.zay.web.controller包下面的所有类中，有@RequestMapping注解的方法。
	 */
	@Pointcut("execution(* com.zay.web.controller..*(..)) and @annotation(org.springframework.web.bind.annotation.RequestMapping)")
	 ...
	 */
	@Around("controllerMethodPointcut()") //指定拦截器规则；也可以直接把“execution(* com.zay.........)”写进这里
